...
model="${this_dir}/model/${1}/model_${1}.best_valid_script"
test="${this_dir}/data/${2}.factors_${1}.de"
candidate_bpe="${this_dir}/eval/${1}/${2}.bpe.en.candidate"
candidate_mrg="${this_dir}/eval/${1}/${2}.en.candidate"
ref_bpe="${this_dir}/data/${2}.bpe.en"
ref_mrg="${this_dir}/data/${2}.en"
