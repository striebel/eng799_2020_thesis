...
if __name__ == '__main__':
    validerr = train(saveto='model/udts/model_udts.npz',
                    reload_=True,
                    dim_word=500,
                    factors=4,
                    ...
                    batch_size=80,
                    valid_batch_size=80,
                    datasets=[DATA_DIR + '/corpus.factors_udts.' + SRC, DATA_DIR + '/corpus.bpe.' + TGT],
                    valid_datasets=[DATA_DIR + '/newstest2013.factors_udts.' + SRC, DATA_DIR + '/newstest2013.bpe.' + TGT],
                    ...
                    overwrite=False,
                    external_validation_script='validate.sh udts')
    print validerr
